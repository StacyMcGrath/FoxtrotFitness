...
INSERT INTO event (event_name, description, long_description, start_date, end_date, user_activity_goal, total_activity_goal, image_name)
VALUES ('Mission to the Moon', 'Can all of us together cover the distance to the moon during 2021? Run, walk, or bike your way across space with us!', 'That’s right, we’ll tally yours and other relay participants’ distance with the hope of virtually covering this huge expanse! It’s an audacious challenge, but with your help and the power of the global running community, we think we can make it!', '2021-01-01', '2021-12-31', 2389, 238900, 'event_9.jpg');
INSERT INTO event (event_name, description, long_description, start_date, end_date, user_activity_goal, total_activity_goal, image_name)
VALUES ('Sea to Sea Cycling', 'Set a goal to cycle the distance from Portland, Oregon to Portland, Maine in a year!', 'The Shining Sea Bikeway (SSB) was named for a line in the song America The Beautiful, written by Falmouth native Katharine Lee Bates. It follows the original route of the New York, New Haven and Hartford Railroad that used to run from Buzzards Bay, through North and West Falmouth, around Woods Hole and into Falmouth Station. In the early 1970’s the Town of Falmouth purchased the right of way, tore up the tracks and officially opened the 3.3-mile Shining Sea Bikeway in 1975.', '2021-01-01', '2021-12-31', 3236, 32360, 'event_10.jpg');
INSERT INTO event (event_name, description, long_description, start_date, end_date, user_activity_goal, total_activity_goal, image_name)
