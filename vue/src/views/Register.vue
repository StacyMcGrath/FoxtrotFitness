  ...
  <div id="register" class="text-center">
    <form @submit.prevent="register">
        <div class="container">
          ...
          <p role="alert" v-if="registrationErrors">{{ registrationErrorMsg }}</p>
          <hr>
          ...
          <input type="password" placeholder="Confirm Password" id="confirmPassword" v-model="user.confirmPassword" required>
          <hr>
